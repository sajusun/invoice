...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/boss/projects/invogen/public/storage' => 'string',
...
'app.aliases.Vite','app.live_url','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
...
'database.migrations.update_date_on_publish','database.redis.client','database.redis.default.url','database.redis.default.host','database.redis.default.password',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./home/boss/projects/invogen/public/storage','logging.default','logging.deprecations.channel',
...
'session.http_only','session.same_site','session.partitioned','concurrency.default','hashing.driver',
...
'signed','throttle','verified','admin','checkPlanExpiry',
'permission','role',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','user.notifications','user.notifications.read',
'admin.notifications','admin.notifications.read','home','main',
'choose-plan','invoice.builder','previewInvoice','invoices','changeStatus','customers.details','customers.update','customers.update','pp','t&c','about',
'careers','blog','guides','support','integrations',
'api-docs','contact.form','contact.form','dashboard','profile.edit',
'profile.update','profile.destroy','customers','settings.edit','settings.update',
'subscription.plan','register','signup.success',
'login','password.request','password.email','password.reset',
'password.store','verification.notice','verification.verify','verification.send','password.confirm','password.update','logout','admin.login','admin.login.submit',
'admin.logout','admin.dashboard','admin.dashboard.users-list','admin.dashboard.user.page','users.destroy',
'users.bulk-delete','admin.dashboard.payments','admin.dashboard.payments.create','admin.dashboard.payments.create','user.data',
'user.password','user.company','payment.form','payment.process','twocheckout.checkout',
'twocheckout.success','admin.project.index','admin.project.update','admin.roles.index','admin.roles.update',
'admin.users.changeRole','admin.users.edit','admin.users.update','admin.users.create','admin.users.store',
'admin.users.delete','admin.profile.edit','admin.profile.update','admin.password.update','storage.local',);
        registerArgumentsSet('views', 
'admin.auth.login','admin.dashboard','admin.make-payment-form','admin.payments','admin.profile.index',
'admin.roles.index','admin.user-info','admin.users-list','admin.users.create','admin.users.edit',
'app','auth.confirm-password','auth.forgot-password','auth.login','auth.register',
'auth.register_success','auth.reset-password','auth.verify-email','components.admin-navbar','components.application-logo',
'components.auth-session-status','components.breadcrumbs','components.breadcrumbs2','components.danger-button','components.dropdown',
'components.dropdown-link','components.input-error','components.input-label','components.modal','components.nav-link',
'components.primary-button','components.responsive-nav-link','components.secondary-button','components.sign-in-up','components.text-input',
'custom-components.admin-dashboard-aside','custom-components.dashboard-aside','custom-components.dashboard-header','custom-components.footer','custom-components.home-nav',
'custom-components.main','custom-components.user_auth_or_not','custom-layouts.auth-or-dashboard','custom-layouts.bottom_script_files','custom-layouts.features_card',
'custom-layouts.footer','custom-layouts.guest_invoice','custom-layouts.headTagContent','custom-layouts.invoice','custom-layouts.layout_customers',
'custom-layouts.navbar','custom-layouts.sidebar_dashboard','custom-template.welcome-mail','dashboard','dashboard2',
'errors.404','errors.500','home','index','invoice-theme.theme-1',
'layouts.admin','layouts.app','layouts.dashboard','layouts.home','layouts.navigation',
'pages.about','pages.api-docs','pages.blog','pages.careers','pages.contact',
'pages.customers.customers_details','pages.customers.customers_list','pages.forgot-password','pages.guest-invoice','pages.guides',
'pages.integrations','pages.invoice','pages.invoice.builder','pages.invoice_preview','pages.invoices_list',
'pages.login','pages.maintenance','pages.preview.guest_preview','pages.preview.preview','pages.privacy',
'pages.register','pages.reset-password','pages.support','pages.terms','payment-page.2checkout',
'payment-page.payment-form','payment-page.stripe-cancel','payment-page.stripe-success','payment-page.twocheckout-success','profile.edit',
'profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','settings.edit','subscription-plan.my-plan',
'subscription-plan.plan','subscription-plan.plan-widget','vendor.mail.html.button','vendor.mail.html.footer','vendor.mail.html.header',
...
'vendor.mail.text.panel','vendor.mail.text.subcopy','vendor.mail.text.table','welcome','laravel-exceptions::401',
...
'APP_URL','GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET','GOOGLE_REDIRECT_URI','FACEBOOK_CLIENT_ID',
'FACEBOOK_CLIENT_SECRET','FACEBOOK_REDIRECT_URI','STRIPE_KEY','STRIPE_SECRET','APP_LOCALE',
...
'FILESYSTEM_DISK','QUEUE_CONNECTION','BROADCAST_CONNECTION','CACHE_STORE','CACHE_PREFIX',
...
'PUSHER_SCHEME','PUSHER_APP_CLUSTER','MAIL_MAILER','MAIL_ENCRYPTION','MAIL_HOST',
