            ...
            <div class="bg-white rounded-xl shadow-sm p-6 card-hover transition-all duration-300">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <h3 class="text-2xl font-bold text-gray-900">{{$num_of_invoices}}</h3>
                    </div>
                </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (canvas) {
                ...
                // Draw points
                const points = [[50, 250], [100, 200], [150, 220], [200, 150], [250, 180], [300, 120], [350, 140]];
                ...
                ctx.fillText('$12k', 10, 40);
                ctx.fillText('$9k', 10, 90);
                ctx.fillText('$6k', 10, 140);
                ctx.fillText('$3k', 10, 190);
                ctx.fillText('$0', 10, 240);

                ctx.fillText('Jan', 45, 265);
                ctx.fillText('Feb', 95, 265);
                ctx.fillText('Mar', 145, 265);
                ctx.fillText('Apr', 195, 265);
                ctx.fillText('May', 245, 265);
                ctx.fillText('Jun', 295, 265);
                ctx.fillText('Jul', 345, 265);
            }
        });
    </script>
</x-dashboard-layout>
