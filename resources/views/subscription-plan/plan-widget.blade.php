...
<div class="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
    ...
    <div class="bg-white rounded-lg shadow p-6 flex flex-col">
        <h2 class="text-2xl font-bold text-gray-800 mb-4">Free Plan</h2>
        ...
        <ul class="text-gray-700 mb-8 space-y-3 text-left">
            <li>✔️ Up to 5 invoices</li>
            <li>✔️ Save 10 customers</li>
            <li>❌ No premium templates</li>
            <li>❌ No priority support</li>
        </ul>
        @if($user->plan_id!=$plans[0]->id)
            <button class="mt-auto bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700 transition">Choose Free
            </button>
        @else
            <button class="mt-auto bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700 transition cursor-alias">
                Activated
            </button>
        @endif
    </div>
    ...
    <div class="bg-white rounded-lg shadow p-6 border-2 border-yellow-500 flex flex-col">
        <h2 class="text-2xl font-bold text-gray-800 mb-4">Premium Plan</h2>
        <p class="text-gray-600 mb-6">For businesses with higher invoicing needs.</p>
        <div class="text-4xl font-bold text-yellow-500 mb-6">$9.99 <span class="text-base font-medium text-gray-500">/Year</span>
        </div>
        ...
        <button class="mt-auto bg-yellow-500 text-white py-2 px-4 rounded hover:bg-yellow-600 transition">Choose
            Premium
        </button>
    </div>
    ...
    <div class="bg-white rounded-lg shadow p-6 flex flex-col">
        <h2 class="text-2xl font-bold text-gray-800 mb-4">Business Plan</h2>
        <p class="text-gray-600 mb-6">For growing companies with extra needs.</p>
        <div class="text-4xl font-bold text-green-600 mb-6">$19.99 <span class="text-base font-medium text-gray-500">/Year</span>
        </div>
        ...
        <button class="mt-auto bg-green-600 text-white py-2 px-4 rounded hover:bg-green-700 transition">Choose
            Business
        </button>
    </div>
