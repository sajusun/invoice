<div class="max-w-3xl mx-auto bg-white p-4 shadow-lg rounded-md mt-1 print:shadow-none print:p-0" id="printable">
    <div class="flex justify-between items-center border-b pb-1">
        ...
        <div class="text-right">
            ...
            @if($invoice_data['paid_amount']>=$invoice_data['total_amount'])
                <div
    ...
    <div class="mt-1">
        <div class="flex justify-between">
            <div class="ml-2">
                ...
                <p class="text-sm text-gray-600">{{$invoice_data['name']}}</p>
                <p class="text-sm text-gray-600">{{$invoice_data['address']}}</p>
                <p class="text-sm text-gray-600">{{$invoice_data['phone']}}</p>
                <p class="text-sm text-gray-600">{{$invoice_data['email']}}</p>
