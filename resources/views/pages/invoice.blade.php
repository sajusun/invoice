...
<div class="invoice-container">
    ...
    <div class="row mt-3">
        ...
        <div class="col-md-6">
            ...
            <input type="date" class="form-control mt-2" placeholder="Due Date">
            <input type="text" class="form-control mt-2" placeholder="PO Number">
        </div>
    </div>
...
<script>
    ...
    function calculateTotal() {
        ...
        rows.forEach(row => {
            ...
            let amount = qty * rate;
            row.cells[3].innerText = `${currency} ${amount.toFixed(2)}`;
            subtotal += amount;
        });
